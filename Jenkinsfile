        ...
        // }
         ...
         stage('Docker Build and Tag') {
           steps {
                ...
                sh 'sudo -S docker build -t samplewebapp:latest .'
                //sh 'sudo -S docker run --rm -d --group-add $(stat -c '%g' /var/run/docker.sock) -v /var/run/docker.sock:/var/run/docker.sock -P samplewebapp:latest'
                sh 'sudo -S docker tag samplewebapp nikhilnidhi/samplewebapp:latest'
